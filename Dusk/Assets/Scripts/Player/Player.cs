...
public class Player : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        UI_HealthBar.instance.SetMaxHealth(maxHealth);
    ...
    public void Damage(int damage)
    {
        ...
        UI_HealthBar.instance.SetHealth(currentHealth);
    ...
    private void HandleInput()
    {
        ...
        {
            xInput = UI_MoveButtons.instance.movementInput;
        }
